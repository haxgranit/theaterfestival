...
ActiveRecord::Schema.define(version: 20170313064560) do
  ...
  create_table "additional_ticket_types", force: :cascade do |t|
  ...
  add_index "additional_ticket_types", ["showtime_id"], name: "index_additional_ticket_types_on_showtime_id", using: :btree
  ...
  add_foreign_key "additional_ticket_types", "showtimes"
