...
class UsersControllerTest < ActionController::TestCase
  ...
  test "should create user" do
    assert_difference('User.count') do
      post :create, user: { email: @another_user.email, first_name: @user.first_name, last_name: @user.last_name, location: @user.location, password: 'secret pass phrase amazing', password_confirmation: 'secret pass phrase amazing', time_zone: @user.time_zone }
    end
